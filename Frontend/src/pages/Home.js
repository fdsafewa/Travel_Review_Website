        ...
        <div className="features-tours-wrap clearfix">
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/1.jpg" data-at2x="pic/tours/1@2x.jpg" alt="" />
              ...
              <h4 className="title"><span className="font-4">United arab emirates</span> Dubai</h4><a href={`/PlaceDetails/666d40519fd22893e8dae2f2`} className="button">Details</a>
              </div>
            </div>
          </div>
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/2.jpg" data-at2x="pic/tours/2@2x.jpg" alt="" />
              ...
              <div className="features-info-bot">
                <h4 className="title"><span className="font-4">United kingdom</span> London</h4> <Link to={`/PlaceDetails/6673debc6f555061460b976d`} className="button">Details</Link>
              </div>
            </div>
          </div>
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/3.jpg" data-at2x="pic/tours/3@2x.jpg" alt="" />
              ...
              <div className="features-info-bot">
                <h4 className="title"><span className="font-4">Australia ans oceania</span> Sydney</h4><a href="/PlaceDetails/6673debc6f555061460b976e" className="button">Details</a>
              </div>
            </div>
          </div>
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/4.jpg" data-at2x="pic/tours/4@2x.jpg" alt="" />
              ...
              <div className="features-info-bot">
                <h4 className="title"><span className="font-4">Brazil</span> Rio de janeiro</h4><a href="/PlaceDetails/667131c5765a685bf6c0514d" className="button">Details</a>
              </div>
            </div>
          </div>
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/5.jpg" data-at2x="pic/tours/5@2x.jpg" alt="" />
              ...
              <div className="features-info-bot">
                <h4 className="title"><span className="font-4">Maldives</span> Male</h4><a href="/PlaceDetails/6673debc6f555061460b9774" className="button">Details</a>
              </div>
            </div>
          </div>
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/6.jpg" data-at2x="pic/tours/6@2x.jpg" alt="" />
              ...
              <div className="features-info-bot">
                <h4 className="title"><span className="font-4">Turkey</span> Istanbul</h4><a href="/PlaceDetails/6673debc6f555061460b977a" className="button">Details</a>
              </div>
            </div>
          </div>
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/7.jpg" data-at2x="pic/tours/7@2x.jpg" alt="" />
              ...
              <div className="features-info-bot">
                <h4 className="title"><span className="font-4">Austria</span> Vienna</h4><a href="/PlaceDetails/6673debc6f555061460b9780" className="button">Details</a>
              </div>
            </div>
          </div>
          <div className="features-tours-item">
            <div className="features-media"><img src="pic/tours/8.jpg" data-at2x="pic/tours/8@2x.jpg" alt="" />
              ...
              <div className="features-info-bot">
                <h4 className="title"><span className="font-4">Italy</span> Venice</h4><a href="/PlaceDetails/6673debc6f555061460b9786" className="button">Details</a>
              </div>
            </div>
          </div>
        </div>
